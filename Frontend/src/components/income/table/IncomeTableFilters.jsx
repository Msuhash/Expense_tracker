...
import { setFilters, resetFilters } from '@/store/slices/incomeSlice';
import { IoMdRefresh } from "react-icons/io";


const IncomeTableFilters = () => {
  ...
  const { categories, incomeCategories } = useSelector((state) => state.category);

  const amountRange = {
    "1-5": { minAmount: 1, maxAmount: 5000 },
  ...
  const handleReset = () => {
    ...
    // Increment resetKey to force Select components to remount
  ...
  return (
    <div className='border border-amber-600 p-4 rounded-lg'>
      ...
      <p className='text-sm text-amber-900 mt-2 text-center md:text-left'>Filter your income data here</p>
