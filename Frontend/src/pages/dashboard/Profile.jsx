  ...
  return (
    <div className='p-4 md:p-6 space-y-6 max-w-4xl mx-auto'>
      <div className='relative flex items-center justify-center mb-6 md:mb-8'>
        <h6 className='text-amber-500 text-center text-xl md:text-2xl font-sans font-bold'>Profile Setting</h6>
        <button
          onClick={handleLogout}
          className='absolute right-0 flex items-center gap-2 px-3 py-2 text-red-500 hover:bg-red-900/20 rounded-lg transition-all duration-300 border border-red-900/30 font-bold active:scale-95 cursor-pointer'
        >
